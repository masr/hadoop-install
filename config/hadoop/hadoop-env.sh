...
-Dhadoop.log.file=hadoop-hdfs-namenode-%H.log \
...
-Dhadoop.log.file=hadoop-hdfs-datanode-%H.log \
...
-Dhadoop.log.file=hadoop-hdfs-zkfc-%H.log \
...
-Dhadoop.log.file=hadoop-hdfs-journalnode-%H.log \
